...
class StageController extends Controller
{
    ...
    public function show(stage $stage)
    {
        ...
        $data['societe']=Societe::all();
        $data['stage']=Stage::all();
        dd($data);
        return view('stage.show')->with('data', $data);
    ...
    public function update(Request $request, stage $stage)
    {
        ...
        return redirect()->route('stage.show', $societe->id)->with('updateStage', 'Stage modifiée avec succées ');
    }
